package com.example.santevistabackendpfe.security;

import com.example.santevistabackendpfe.services.ApplicationUserDetailsService;
...
public class SecurityConfiguration {
    private static final String[] whitelist = {"/public/**", "/api-docs.html", "/v3/api-docs/**", "/swagger-ui/**"};
